...
class TestPLMLoss(unittest.TestCase):
    ...
    def test_forward_returns_scalar(self):
        ...
        loss_fn = PLMLoss(label_distribution=label_dist, lambda_rate=0.1, hist_bins=5, loss_kernel="bce")
    ...
    def test_update_ratios_changes_ideal(self):
        ...
        loss_fn = PLMLoss(label_distribution=label_dist, lambda_rate=0.5, hist_bins=3, loss_kernel="bce")
